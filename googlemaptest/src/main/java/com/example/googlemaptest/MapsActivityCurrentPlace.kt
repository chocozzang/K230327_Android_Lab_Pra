...
// 1. 코드 복사
// 2. 없는 라이브러리를 외부에서 가져와야함 -> dependency 추가
// 3. BuildConfig.MAPS_API_KEY -> 문자열 파일, 양쪽에 " " 수정
// --> Places.initialize(CONTEXT, STRING)
// local.properties 파일 내에 MAP_API_KEY = 발급받은 APIKEY로 설정
// 4. 뷰 설정
// 4-1. R.menu.current_place_menu & @string/option_get_place, default_info_title, default_info_snippet, pick_place
// 4-2. custom_info_contents.xml
// 4-3. activity_maps.xml
// 5. Manifest의 APIKEY는 변경
// 6. Location -> 검색어 : Busan ->

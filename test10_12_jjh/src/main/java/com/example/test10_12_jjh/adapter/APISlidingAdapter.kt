...
// 커스텀 뷰홀더
// 아이템에 대한 뷰를 바인딩함
class APISlidingViewHolder(val binding : ItemPracticeBinding) : RecyclerView.ViewHolder(binding.root)

// 커스텀 어댑터
// onCreateViewHolder
// getItemCount
// onBindViewHolder를 Implement할 것
class APISlidingAdapter(val context : Context, val datas: MutableList<TideModel>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
//    private var datas : MutableList<TideModel> = ArrayList()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder 
        = APISlidingViewHolder(ItemPracticeBinding.inflate(LayoutInflater.from(parent.context), parent, false))
...
//    fun setDatas(datas_ : MutableList<TideModel>) {
//        datas = datas_
//    }
}